...
////    public static final TETile CAT = new TETile('c', Color.orange, Color.black, "ghost", "pixel_frog_jumping.png");
////}
////
//
//package byow.TileEngine;
...
//
//public class Tileset {
////    public static final TETile WALL = new TETile('♥', new Color(242, 107, 138), new Color(229, 164, 179), "wall");
...
//    public static final TETile GRASS = new TETile('"', Color.green, Color.black, "grass");
//    public static final TETile WATER = new TETile('≈', Color.blue, Color.black, "water");
//    public static final TETile FLOWER = new TETile('❀',  new Color(230, 203, 202, 255),  new Color(230, 203, 202, 255), "flower");
//    public static final TETile LOCKED_DOOR = new TETile('█', Color.orange, Color.black,
//            "locked door");
//    public static final TETile UNLOCKED_DOOR = new TETile('▢', Color.orange, Color.black,
//            "unlocked door");
...
//    public static final TETile MOUNTAIN = new TETile('▲', Color.gray, Color.black, "mountain");
//    public static final TETile TREE = new TETile('♠', Color.green, Color.black, "tree");
//    public static final TETile CAT = new TETile('⚘', new Color(222, 187, 147, 255), new Color(69, 54, 48, 255), "crazy frog", "pixel_frog_jumping.png");
//}
//
